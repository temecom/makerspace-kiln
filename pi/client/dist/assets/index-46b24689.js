...
const toDisplayString = (val) => {
  return isString$1(val) ? val : val == null ? "" : isArray$2(val) || isObject$2(val) && (val.toString === objectToString || !isFunction$3(val.toString)) ? isRef$1(val) ? toDisplayString(val.value) : JSON.stringify(val, replacer, 2) : String(val);
};
...
function callHook(hook, instance, type) {
  callWithAsyncErrorHandling(
    isArray$2(hook) ? hook.map((h3) => h3.bind(instance.proxy)) : hook.bind(instance.proxy),
    instance,
    type
  );
}
...
function dispatchRequest(config) {
  ...
  const adapter = adapters$1.getAdapter(config.adapter || defaults$2.adapter, config);
...
axios.default = axios;
const axios$1 = axios;
const TestTempControl_vue_vue_type_style_index_0_scoped_f4013893_lang = "";
...
const _hoisted_1$7 = { class: "card test-temp-panel" };
const _hoisted_2$5 = {
  key: 0,
  class: "message"
};
...
const _sfc_main$7 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const setSimulatedTemp = async () => {
      try {
        await axios$1.post("/api/test/temp", { temperature: localTemperature.value });
        message.value = `Simulated temperature set to ${localTemperature.value}°C`;
        emit2("update:temperature", localTemperature.value);
      } catch (err) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$7, [
        _cache[2] || (_cache[2] = createBaseVNode("h3", null, "Simulated Temperature", -1)),
        message.value ? (openBlock(), createElementBlock("div", _hoisted_2$5, toDisplayString(message.value), 1)) : createCommentVNode("", true),
        createBaseVNode("div", _hoisted_3$5, [
          _cache[1] || (_cache[1] = createBaseVNode("label", null, "Set Simulated Temp (°C)", -1)),
          withDirectives(createBaseVNode("input", {
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => localTemperature.value = $event),
            type: "number",
            onChange: setSimulatedTemp
          }, null, 544), [
            [
              vModelText,
...
const TestTempControl = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-f4013893"]]);
const KilnDashboard_vue_vue_type_style_index_0_scoped_2522b75b_lang = "";
const _hoisted_1$6 = { class: "dashboard" };
const _hoisted_2$4 = { class: "status-header" };
const _hoisted_3$4 = { class: "countdown-timer" };
const _hoisted_4$4 = { class: "value" };
const _hoisted_5$4 = { class: "readings" };
const _hoisted_6$3 = { class: "reading" };
const _hoisted_7$3 = { class: "value" };
const _hoisted_8$3 = { class: "reading" };
const _hoisted_9$2 = { class: "value" };
const _hoisted_10$2 = { class: "reading" };
const _hoisted_11$1 = { class: "value" };
const _hoisted_12$1 = { class: "ssr-status" };
const _hoisted_13$1 = {
  key: 0,
  class: "warning"
};
...
const _hoisted_16$1 = { class: "controls-grid" };
const _sfc_main$6 = {
  __name: "KilnDashboard",
  props: {
    testParams: Object,
    profile: Object
    // Not used directly, but needed for the component signature
  },
  emits: ["update:testParams"],
  setup(__props, { emit: __emit }) {
    const props = __props;
    const emit2 = __emit;
    const status = ref({
    ...
    const isStale = computed(() => {
      if (!status.value.timestamp)
        return true;
      return Date.now() - status.value.timestamp > 15e3;
    });
    const countdown = computed(() => {
      if (status.value.remainingTime === void 0 || status.value.remainingTime === null)
        return "00:00:00";
    ...
    const handleTempUpdate = (newTemp) => {
      emit2("update:testParams", { ...props.testParams, temperature: newTemp });
    };
    onMounted(() => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$6, [
        createBaseVNode("div", {
          class: normalizeClass(["status-panel", { stale: isStale.value }])
        }, [
          createBaseVNode("div", _hoisted_2$4, [
            createBaseVNode("h2", null, "Status: " + toDisplayString(status.value.state), 1),
            createBaseVNode("div", _hoisted_3$4, [
              _cache[0] || (_cache[0] = createBaseVNode("span", { class: "label" }, "Time Remaining", -1)),
              createBaseVNode("span", _hoisted_4$4, toDisplayString(countdown.value), 1)
            ])
          ]),
          createBaseVNode("div", _hoisted_5$4, [
            createBaseVNode("div", _hoisted_6$3, [
              _cache[1] || (_cache[1] = createBaseVNode("span", { class: "label" }, "Current Temp", -1)),
              createBaseVNode("span", _hoisted_7$3, toDisplayString(status.value.input ? status.value.input.toFixed(1) : "--") + " °C", 1)
            ]),
            createBaseVNode("div", _hoisted_8$3, [
              _cache[2] || (_cache[2] = createBaseVNode("span", { class: "label" }, "Setpoint", -1)),
              createBaseVNode("span", _hoisted_9$2, toDisplayString(status.value.setpoint ? status.value.setpoint.toFixed(1) : "--") + " °C", 1)
            ]),
            createBaseVNode("div", _hoisted_10$2, [
              _cache[3] || (_cache[3] = createBaseVNode("span", { class: "label" }, "Target", -1)),
              createBaseVNode("span", _hoisted_11$1, toDisplayString(status.value.targetTemperature) + " °C", 1)
            ])
          ]),
          createBaseVNode("div", _hoisted_12$1, [
            createBaseVNode("span", {
              class: normalizeClass(status.value.ssrUpper ? "ssr-active" : "ssr-inactive")
            }, "Upper: " + toDisplayString(status.value.ssrUpper ? "ON" : "OFF"), 3),
            createBaseVNode("span", {
              class: normalizeClass(status.value.ssrLower ? "ssr-active" : "ssr-inactive")
            }, "Lower: " + toDisplayString(status.value.ssrLower ? "ON" : "OFF"), 3)
          ]),
          isStale.value ? (openBlock(), createElementBlock("p", _hoisted_13$1, "Status is stale. (Last update: " + toDisplayString(new Date(status.value.timestamp).toLocaleTimeString()) + ")", 1)) : createCommentVNode("", true),
          isSimulated.value ? (openBlock(), createElementBlock("p", _hoisted_14$1, "SIMULATION MODE ACTIVE")) : createCommentVNode("", true)
        ], 2),
        message.value ? (openBlock(), createElementBlock("div", _hoisted_15$1, toDisplayString(message.value), 1)) : createCommentVNode("", true),
        createBaseVNode("div", _hoisted_16$1, [
          createBaseVNode("div", { class: "card control-panel" }, [
            _cache[4] || (_cache[4] = createBaseVNode("h3", null, "Controls", -1)),
          ...
          isSimulated.value ? (openBlock(), createBlock(TestTempControl, {
            key: 0,
            temperature: __props.testParams.temperature,
            "onUpdate:temperature": handleTempUpdate
          }, null, 8, ["temperature"])) : createCommentVNode("", true)
        ])
      ]);
    };
  }
};
const KilnDashboard = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-2522b75b"]]);
const ProfileView_vue_vue_type_style_index_0_scoped_1c43a4e0_lang = "";
const _hoisted_1$5 = { class: "card profile-panel" };
const _hoisted_2$3 = {
  key: 0,
  class: "message"
};
...
const _sfc_main$5 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const updateProfile = async () => {
      try {
        await axios$1.post("/api/profile", props.profile);
    ...
    const updateField = (field, value) => {
      emit2("update:profile", { ...props.profile, [field]: value });
    };
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$5, [
        _cache[8] || (_cache[8] = createBaseVNode("h3", null, "Firing Profile", -1)),
        message.value ? (openBlock(), createElementBlock("div", _hoisted_2$3, toDisplayString(message.value), 1)) : createCommentVNode("", true),
        createBaseVNode("div", _hoisted_3$3, [
          _cache[4] || (_cache[4] = createBaseVNode("label", null, "Target Temp (°C)", -1)),
          createBaseVNode("input", {
            value: __props.profile.targetTemperature,
            onInput: _cache[0] || (_cache[0] = ($event) => updateField("targetTemperature", $event.target.valueAsNumber)),
            type: "number"
          }, null, 40, _hoisted_4$3)
        ]),
        createBaseVNode("div", _hoisted_5$3, [
          _cache[5] || (_cache[5] = createBaseVNode("label", null, "Ramp Time (min)", -1)),
          createBaseVNode("input", {
            value: __props.profile.rampTime,
            onInput: _cache[1] || (_cache[1] = ($event) => updateField("rampTime", $event.target.valueAsNumber)),
            type: "number"
          }, null, 40, _hoisted_6$2)
        ]),
        createBaseVNode("div", _hoisted_7$2, [
          _cache[6] || (_cache[6] = createBaseVNode("label", null, "Soak Duration (min)", -1)),
          createBaseVNode("input", {
            value: __props.profile.soakDuration,
            onInput: _cache[2] || (_cache[2] = ($event) => updateField("soakDuration", $event.target.valueAsNumber)),
            type: "number"
          }, null, 40, _hoisted_8$2)
        ]),
        createBaseVNode("div", _hoisted_9$1, [
          _cache[7] || (_cache[7] = createBaseVNode("label", null, "Cool Time (min)", -1)),
          createBaseVNode("input", {
            value: __props.profile.coolTime,
            onInput: _cache[3] || (_cache[3] = ($event) => updateField("coolTime", $event.target.valueAsNumber)),
            type: "number"
          }, null, 40, _hoisted_10$1)
        ]),
        createBaseVNode("button", { onClick: updateProfile }, "Update Profile")
      ]);
    };
  }
};
const ProfileView = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-1c43a4e0"]]);
const TestView_vue_vue_type_style_index_0_scoped_1df9b842_lang = "";
const _hoisted_1$4 = { class: "card test-panel" };
const _hoisted_2$2 = {
  key: 0,
  class: "message"
};
...
const _sfc_main$4 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const startTest = async () => {
      try {
        await axios$1.post("/api/test", props.testParams);
    ...
    const updateField = (field, value) => {
      emit2("update:testParams", { ...props.testParams, [field]: value });
    };
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$4, [
        _cache[6] || (_cache[6] = createBaseVNode("h3", null, "Test Mode", -1)),
        message.value ? (openBlock(), createElementBlock("div", _hoisted_2$2, toDisplayString(message.value), 1)) : createCommentVNode("", true),
        createBaseVNode("div", _hoisted_3$2, [
          _cache[3] || (_cache[3] = createBaseVNode("label", null, "Simulated Temp (°C)", -1)),
          createBaseVNode("input", {
            value: __props.testParams.temperature,
            onInput: _cache[0] || (_cache[0] = ($event) => updateField("temperature", $event.target.valueAsNumber)),
            type: "number"
          }, null, 40, _hoisted_4$2)
        ]),
        createBaseVNode("div", _hoisted_5$2, [
          _cache[4] || (_cache[4] = createBaseVNode("label", null, "Duration (min)", -1)),
          createBaseVNode("input", {
            value: __props.testParams.duration,
            onInput: _cache[1] || (_cache[1] = ($event) => updateField("duration", $event.target.valueAsNumber)),
            type: "number"
          }, null, 40, _hoisted_6$1)
        ]),
        createBaseVNode("div", _hoisted_7$1, [
          _cache[5] || (_cache[5] = createBaseVNode("label", null, "Setpoint (°C)", -1)),
          createBaseVNode("input", {
            value: __props.testParams.setPoint,
            onInput: _cache[2] || (_cache[2] = ($event) => updateField("setPoint", $event.target.valueAsNumber)),
            type: "number"
          }, null, 40, _hoisted_8$1)
        ]),
        createBaseVNode("button", { onClick: startTest }, "Start Test Simulation")
      ]);
    };
  }
};
const TestView = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-1df9b842"]]);
const HistoryView_vue_vue_type_style_index_0_scoped_c7339f72_lang = "";
const _hoisted_1$3 = { class: "card history-view" };
const _hoisted_2$1 = { class: "history-header" };
const _hoisted_3$1 = { class: "header-buttons" };
...
const _hoisted_10 = { class: "session-summary" };
...
const _hoisted_18 = { class: "state-label" };
const _sfc_main$3 = {
  __name: "HistoryView",
  setup(__props) {
    const sessions = ref([]);
    ...
    const fetchHistory = async () => {
      ...
      error.value = null;
      try {
        const response = await axios$1.get("/api/history");
    ...
    const clearHistory = async () => {
      ...
      try {
        await axios$1.delete("/api/history");
        await fetchHistory();
      } catch (err) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        createBaseVNode("div", _hoisted_2$1, [
          _cache[1] || (_cache[1] = createBaseVNode("h3", null, "Run History", -1)),
          createBaseVNode("div", _hoisted_3$1, [
            createBaseVNode("button", {
              onClick: fetchHistory,
              disabled: loading.value
            }, "Refresh", 8, _hoisted_4$1),
            createBaseVNode("button", {
              onClick: clearHistory,
              disabled: loading.value || sessions.value.length === 0,
              class: "clear-btn"
            }, "Clear All", 8, _hoisted_5$1)
          ])
        ]),
        loading.value ? (openBlock(), createElementBlock("div", _hoisted_6, "Loading history...")) : createCommentVNode("", true),
        error.value ? (openBlock(), createElementBlock("div", _hoisted_7, toDisplayString(error.value), 1)) : createCommentVNode("", true),
        !loading.value && !error.value ? (openBlock(), createElementBlock("div", _hoisted_8, [
          sessions.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_9, " No history records found. ")) : createCommentVNode("", true),
          (openBlock(true), createElementBlock(Fragment, null, renderList(sessions.value, (session) => {
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode("div", _hoisted_10, [
                createBaseVNode("span", {
                  class: "session-id",
                  onClick: withModifiers(($event) => toggleSessionDetails(session.id), ["stop"])
                }, "Session #" + toDisplayString(session.id), 9, _hoisted_11),
                createBaseVNode("span", {
                  class: "session-time",
                  onClick: withModifiers(($event) => toggleSessionDetails(session.id), ["stop"])
                }, toDisplayString(formatTimestamp(session.startTime)), 9, _hoisted_12),
                createBaseVNode("span", {
                  class: normalizeClass(["session-status", `status-${session.status.toLowerCase()}`]),
                  onClick: withModifiers(($event) => toggleSessionDetails(session.id), ["stop"])
                }, toDisplayString(session.status), 11, _hoisted_13),
                createBaseVNode("span", {
                  class: "session-events-count",
                  onClick: withModifiers(($event) => toggleSessionDetails(session.id), ["stop"])
                }, toDisplayString(session.events.length) + " events", 9, _hoisted_14),
                createBaseVNode("a", {
                  href: `#/history/plot?sessionId=${session.id}`,
                  class: "plot-link-btn",
                ...
                createBaseVNode("span", {
                  ...
                  onClick: withModifiers(($event) => toggleSessionDetails(session.id), ["stop"])
                }, toDisplayString(expandedSessionId.value === session.id ? "▼" : "▶"), 9, _hoisted_16)
              ]),
              expandedSessionId.value === session.id ? (openBlock(), createElementBlock("div", _hoisted_17, [
                createBaseVNode("table", null, [
                  _cache[2] || (_cache[2] = createBaseVNode("thead", null, [
                    createBaseVNode("tr", null, [
                      createBaseVNode("th", null, "Time (MM:SS)"),
                      createBaseVNode("th", null, "State"),
                      createBaseVNode("th", null, "Temp (°C)"),
                      createBaseVNode("th", null, "Setpoint (°C)"),
                      createBaseVNode("th", null, "Target (°C)")
                    ])
                  ], -1)),
                  createBaseVNode("tbody", null, [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(session.events, (event, index) => {
                      var _a2, _b2;
                      return openBlock(), createElementBlock("tr", { key: index }, [
                        createBaseVNode("td", null, toDisplayString(formatElapsedTime(event.elapsedTime)), 1),
                        createBaseVNode("td", null, [
                          createBaseVNode("span", _hoisted_18, toDisplayString(event.state), 1)
                        ]),
                        createBaseVNode("td", null, toDisplayString(((_a2 = event.input) == null ? void 0 : _a2.toFixed(1)) || "--"), 1),
                        createBaseVNode("td", null, toDisplayString(((_b2 = event.setpoint) == null ? void 0 : _b2.toFixed(1)) || "--"), 1),
                        createBaseVNode("td", null, toDisplayString(event.targetTemperature || "--"), 1)
                      ]);
                    }), 128))
                  ])
                ])
...
const HistoryView = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-c7339f72"]]);
const PreferenceView_vue_vue_type_style_index_0_scoped_2c3d7b76_lang = "";
const _sfc_main$2 = {};
const _hoisted_1$2 = { class: "card" };
function _sfc_render(_ctx, _cache) {
  return openBlock(), createElementBlock("div", _hoisted_1$2, [..._cache[0] || (_cache[0] = [
    createBaseVNode("h3", null, "Preferences", -1),
    createBaseVNode("p", null, "Not yet implemented.", -1)
  ])]);
}
const PreferenceView = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render], ["__scopeId", "data-v-2c3d7b76"]]);
/*!
 * @kurkle/color v0.3.4
...
function styleChanged(style2, prevStyle) {
  ...
  return JSON.stringify(style2, replacer2) !== JSON.stringify(prevStyle, replacer2);
}
...
const PlotView_vue_vue_type_style_index_0_scoped_547d2843_lang = "";
const _hoisted_1$1 = { class: "card plot-view" };
const _hoisted_2 = { class: "plot-header" };
const _hoisted_3 = {
  key: 0,
  class: "loading"
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
      ...
      return {
        ...
        datasets: [
          ...
          },
          {
            ...
            data: events.map((e) => e.ssrUpper ? maxTemp * 0.1 : 0),
            // Scale to 5% of max temp
            yAxisID: "y",
            type: "bar"
          },
          {
            ...
            data: events.map((e) => e.ssrLower ? maxTemp * 0.1 : 0),
            // Scale to 2.5% of max temp
            yAxisID: "y",
            type: "bar"
          }
        ]
    ...
    const fetchSession = async () => {
      ...
      try {
        const response = await axios$1.get(`/api/history/${props.sessionId}`);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("h3", null, "Run #" + toDisplayString(__props.sessionId) + " - Temperature Plot", 1),
          _cache[0] || (_cache[0] = createBaseVNode("a", {
            href: "#history",
            class: "back-link"
          }, "Back to History", -1))
        ]),
        loading.value ? (openBlock(), createElementBlock("div", _hoisted_3, "Loading plot data...")) : createCommentVNode("", true),
        error.value ? (openBlock(), createElementBlock("div", _hoisted_4, toDisplayString(error.value), 1)) : createCommentVNode("", true),
        session.value ? (openBlock(), createElementBlock("div", _hoisted_5, [
...
const PlotView = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-547d2843"]]);
const App_vue_vue_type_style_index_0_scoped_24f12a48_lang = "";
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        _cache[2] || (_cache[2] = createStaticVNode('<header data-v-24f12a48><h1 data-v-24f12a48>Kiln Controller</h1><nav data-v-24f12a48><a href="#/" data-v-24f12a48>Dashboard</a><a href="#/profile" data-v-24f12a48>Profile</a><a href="#/test" data-v-24f12a48>Test</a><a href="#/history" data-v-24f12a48>History</a><a href="#/preferences" data-v-24f12a48>Preferences</a></nav></header>', 1)),
        createBaseVNode("main", null, [
          (openBlock(), createBlock(resolveDynamicComponent(currentView.value), mergeProps(currentViewProps.value, {
            "onUpdate:profile": _cache[0] || (_cache[0] = ($event) => Object.assign(profile.value, $event)),
            "onUpdate:testParams": _cache[1] || (_cache[1] = ($event) => Object.assign(testParams.value, $event))
          }), null, 16))
        ])
      ]);
    };
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-24f12a48"]]);
createApp(App).mount("#app");
//# sourceMappingURL=index-46b24689.js.map
